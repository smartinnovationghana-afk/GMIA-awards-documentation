...
A secret token that authenticates requests to the platform's API. Keys are scoped to a workspace and inherit the permissions of whoever created them. See [technical-statistics](../main-modules/technical-statistics/ "mention").
...
A workspace role that can view published deploys but nothing else. Guests don't count towards your member limit. See [technical-statistics](../main-modules/technical-statistics/ "mention").
...
A deployable unit. Each project has its own source, builds, deploys, environment, and domains. Projects are isolated from each other within a workspace. See [security](../main-modules/security/ "mention").
...
A workspace-level designation that determines what a member can do. Roles are: Guest, Viewer, Reviewer, Editor, and Admin. See [technical-statistics](../main-modules/technical-statistics/ "mention").
...
The top-level container for a team's work. Owns billing, members, and projects. See [security](../main-modules/security/ "mention").
